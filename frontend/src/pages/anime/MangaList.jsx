...
import { ANILIST_MANGA_TABS, MODAL_EDIT_MEDIA_ID } from '../../constants/anilist'
...
const MangaList = () => {
    const { watchList, loading, editEntry, setEditEntry } = useAnilist()
                ...
                <>
                    ...
                    <div className="container mx-auto p-3 sm:p-6">
                        ...
                        <div className="mb-4 flex items-center justify-between gap-4">
                            <h2 className="text-highlight text-2xl font-bold text-nowrap sm:text-3xl">Your Anime List</h2>
