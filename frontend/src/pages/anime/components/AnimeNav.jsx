        ...
        <nav className="bg-primary mx-auto block w-full max-w-screen-lg px-4 py-2 lg:px-8 lg:py-3">
            <div className="container mx-auto flex flex-wrap items-center justify-center gap-3 md:gap-5">
                <button
                    type="button"
                    title="Anime List"
                    onClick={() => handleTabChange(TabEnum.ANIME)}
                    className={`neu-btn ${activeTab === TabEnum.ANIME ? 'active' : ''} neu-icon-btn gap-1 text-nowrap px-2 py-2 md:gap-2 md:px-4 md:py-2 md:text-base`}>
                ...
                <button
                    type="button"
                    title="Manga List"
                    onClick={() => handleTabChange(TabEnum.MANGA)}
                    className={`neu-btn ${activeTab === TabEnum.MANGA ? 'active' : ''} neu-icon-btn gap-1 text-nowrap px-2 py-2 md:gap-2 md:px-4 md:py-2 md:text-base`}>
                    <svg
                        fill="currentColor"
                        viewBox="0 0 32 32"
                        version="1.1"
                ...
                <button
                    type="button"
                    title="Favorite List"
                    onClick={() => handleTabChange(TabEnum.FAVORITES)}
                    className={`neu-btn ${activeTab === TabEnum.FAVORITES ? 'active' : ''} neu-icon-btn gap-1 text-nowrap px-2 py-2 md:gap-2 md:px-4 md:py-2 md:text-base`}>
                ...
                <button
                    type="button"
                    title="Log Out"
                    onClick={() => handleTabChange(TabEnum.LOGOUT)}
