    ...
    return (
        <div className="bg-primary text-primary h-full w-full p-2 md:max-w-64">
            ...
            <div className="flex items-center justify-between gap-3 md:mb-4">
                <div className="bg-secondary h-10 w-full animate-pulse rounded"></div>
                <div className="bg-secondary h-10 w-10 animate-pulse rounded md:hidden"></div>
            </div>
            ...
            <div className="hidden p-2 md:block">
                {/* Lists Skeleton */}
                <div className="mt-4">
                    <div className="bg-secondary mb-2 h-6 w-24 animate-pulse rounded"></div>
                    <div className="space-y-2" role="listbox" aria-label="Filter by list">
                        {Array.from({ length: 3 }).map((_, index) => (
                            <div key={index} className="bg-secondary h-8 w-full animate-pulse rounded"></div>
                        ))}
                    </div>
                </div>
