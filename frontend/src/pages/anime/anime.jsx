        ...
        <div>
            ...
            <nav className="bg-primary mx-auto block w-full max-w-screen-lg rounded-md px-4 py-2 lg:px-8 lg:py-3">
                <div className="text-secondary container mx-auto flex flex-wrap items-center justify-center gap-5">
                    ...
                    <button type="button" title="Manga List" className="neu-btn neu-icon-btn text-nowrap text-base">
                        <svg fill="currentColor" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" className="size-5 shrink-0">
                    ...
                    <button type="button" title="Favorite List" className="neu-btn neu-icon-btn text-nowrap text-base">
                        <Icon icon="icomoon-free:heart" className="size-5 shrink-0" />
                        Favorites
                    </button>

                    <button type="button" title="Log Out" className="neu-btn neu-icon-btn text-nowrap text-base text-red-500 dark:text-red-500">
                        <Icon icon="majesticons:logout" className="size-5 shrink-0" />
                        Log Out
                    </button>
                </div>
            </nav>
