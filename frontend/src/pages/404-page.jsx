            ...
            <div className="grid place-items-center">
                <svg
                    ...
                    <line
                        ...
                        y2="245.135"
                    />
                    <circle cx="68.732" cy="93" fill="#131313" r="9" />
                    <path
                        ...
                        opacity="0.24"
                    />
                    <circle cx="156.398" cy="93" fill="#131313" r="9" />
                    <ellipse cx="67.732" cy="140.894" enableBackground="new" fill="#dc2626" opacity="0.28" rx="17.372" ry="8.106" />
                    <ellipse cx="154.88" cy="140.894" enableBackground="new" fill="#dc2626" opacity="0.28" rx="17.371" ry="8.106" />
                    <path
                        ...
                        fill="#FFEFB5"
                    />
                    <circle cx="113" cy="113" fill="none" r="109" stroke="#131313" strokeWidth="8" />
                </svg>
