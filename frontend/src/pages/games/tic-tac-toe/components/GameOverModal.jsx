...
const GameOverModal = ({ clearBoard, status }) => {
    ...
    return (
        <motion.div
            ...
            aria-label={status}
            aria-live="assertive"
            className="before:bg-primary text-primary border-light-secondary bg-opacity-10 dark:border-dark-secondary absolute inset-0 z-10 flex h-full w-full flex-col items-center justify-center rounded-xl border text-center tracking-widest before:absolute before:inset-0 before:-z-10 before:size-full before:opacity-70 before:blur-xs before:saturate-150">
