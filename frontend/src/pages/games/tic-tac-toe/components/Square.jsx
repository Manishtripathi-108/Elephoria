...
const Square = ({ squareValue, handleClick, isActive = false, iconSize = 'size-7 md:size-12 text-xl md:text-4xl', isWinningSquare = false }) => {
    return (
        <button
            ...
            className={cn(
                'text-text-secondary font-julee shadow-neumorphic-xs active:shadow-neumorphic-inset-xs flex items-center justify-center rounded-md p-1 transition-all md:p-2',
                iconSize,
                {
