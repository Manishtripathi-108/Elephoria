...
const ScoreBoard = ({ playerX, playerO, drawScore }) => {
    return (
        <div className="flex w-full flex-wrap items-center justify-center gap-5 px-4 font-indie-flower tracking-wider">
            ...
            <div className="text-highlight order-3 w-36 rounded-lg p-4 text-center shadow-neu-inset-light-sm dark:shadow-neu-inset-dark-sm sm:order-2 sm:w-60">
            ...
            <div className="text-highlight order-2 w-36 rounded-lg p-4 text-center shadow-neu-inset-light-sm dark:shadow-neu-inset-dark-sm sm:order-3 sm:w-60">
                <h3 className="mb-2 rounded-lg p-3 font-bold shadow-neu-light-xs dark:shadow-neu-dark-xs">
