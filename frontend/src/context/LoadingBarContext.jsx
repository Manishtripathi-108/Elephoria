    ...
    return (
        <LoadingBarContext.Provider value={contextValue}>
            <LoadingBar
                ...
                height={3}
                waitingTime={300}
                className="after:bg-shimmerRayAccent after:animate-shimmerRay relative overflow-hidden rounded-e-full after:absolute after:left-[-30%] after:top-0 after:h-full after:w-0"
            />
            <LoadingBar
                color="#1E90FF"
                shadow={false}
                ...
                height={3}
                waitingTime={300}
                className="after:bg-shimmerRayHighlight after:animate-shimmerRay relative overflow-hidden rounded-e-full after:absolute after:left-[-30%] after:top-0 after:h-full after:w-0"
            />
            {children}
