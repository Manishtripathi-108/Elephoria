...
const Pagination = ({ className = '', currentPage, totalPages, setPage }) => {
    ...
    return (
        <div className={cn('bg-primary border-secondary shadow-neumorphic-xs rounded-full border p-3', className)}>
            <ul className="flex list-none items-center justify-center">
                {/* Previous Arrow */}
                <li className="bg-primary border-secondary shadow-neumorphic-xs active:shadow-neumorphic-inset-xs mx-1 flex-1 rounded-full border first:mr-2 last:ml-2 sm:first:mr-4 sm:last:ml-4">
                    <button
                ...
                {totalPages > maxVisible && currentPage < totalPages - 1 && (
                    <li className="bg-primary border-secondary shadow-neumorphic-xs mx-1 flex-1 rounded-full border">
