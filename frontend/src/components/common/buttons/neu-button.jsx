...
const NeuButton = ({ children, onClick, className = '', ...props }) => {
    return (
        <button
            onClick={onClick}
            className={`bg-primary dark:lineargradient-dark lineargradient-light group flex items-center justify-center overflow-hidden rounded-full border border-light-secondary p-1.5 shadow-neu-light-xs dark:border-dark-secondary dark:shadow-neu-dark-xs ${className}`}
            {...props}>
