    ...
    return (
        <button
            ...
            className={cn(
                ...
                {
                    'text-text-secondary [--gradient-end:#e6a4a7] [--gradient-start:#ffc3c6] [--sh-end:#ffcfd3] [--sh-start:#db9d9f] dark:[--gradient-end:#364253] dark:[--gradient-start:#1f2937] dark:[--sh-end:#324258] dark:[--sh-start:#0c1016]':
                        variant === 'primary',
                    'text-text-primary border-primary [--gradient-end:#fff4f4] [--gradient-start:#FFE6E6] dark:[--gradient-end:#4b5a6c] dark:[--gradient-start:#334155]':
                        variant === 'secondary',
