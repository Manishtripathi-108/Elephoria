...
const ThemeToggleBtn = () => {
    ...
    const buttonClass =
        'text-secondary hover:text-primary data-[state=active]:text-primary inline-flex h-[var(--sz)] max-h-[var(--sz)] min-h-[var(--sz)] w-[var(--sz)] min-w-[var(--sz)] max-w-[var(--sz)] items-center justify-center rounded-full border-light-secondary p-0.5 ring-offset-light-secondary transition-all [--sz:36px] hover:bg-transparent focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-light-secondary focus-visible:ring-offset-1 active:shadow-neumorphic-inset-xs disabled:pointer-events-none disabled:opacity-50 data-[state=active]:border data-[state=active]:shadow-neumorphic-xs data-[state=""]:hover:scale-105 data-[state=""]:active:scale-95 dark:border-dark-secondary dark:ring-offset-dark-secondary dark:focus-visible:ring-dark-secondary'
    return (
