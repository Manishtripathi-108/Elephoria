...
const Toast = ({ message, duration = 3000, type = 'success', onDismiss }) => {
    ...
    return (
        <motion.div
            ...
            <svg className="absolute top-8 -left-8 w-20 shrink-0 rotate-90 fill-current" viewBox="0 0 1440 320" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <p className="m-0 line-clamp-3 cursor-default text-sm tracking-wider select-none">{message}</p>
