...
const UploadInput = ({ acceptType, className, file, id, setFile }) => {
    ...
    return (
        <div
            className={cn(
                'bg-primary border-light-secondary shadow-neumorphic-sm dark:border-dark-secondary flex size-80 flex-col items-center justify-between gap-2 rounded-lg border p-2.5',
                className
            )}>
            <label
                htmlFor={id}
