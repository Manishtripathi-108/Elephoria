...
const Sidenav = ({ onDismiss }) => {
    return (
        <dialog
            ...
            {/* Profile Section */}
            <div className="border-light-secondary dark:border-dark-secondary flex items-center justify-between gap-4 border-b border-dotted p-4">
            ...
            <nav className="scrollbar-thin space-y-1 overflow-y-auto p-4">
                        ...
                        <div className="group">
                            {item.link ? (
                                <Link
                                    to={item.link}
                                    onClick={onDismiss}
                                    className="hover:text-primary text-secondary font-aladin hover:border-light-secondary hover:shadow-neumorphic-xs dark:hover:border-dark-secondary flex w-full cursor-pointer items-center justify-between rounded-lg border border-transparent bg-inherit p-3 text-left tracking-widest transition">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div key={idx} className="group pl-4">
                                            {child.link ? (
                                                <Link
                                                    to={child.link}
                                                    onClick={onDismiss}
                                                    className="text-secondary hover:text-primary hover:border-light-secondary hover:shadow-neumorphic-xs dark:hover:border-dark-secondary flex w-full items-center gap-3 rounded-lg border border-transparent bg-inherit p-2 text-sm transition">
                                                    {child.name}
                                                </Link>
                                            ) : (
                                                <>
                                                ...
                                                <div className="max-h-0 overflow-hidden rounded-lg transition-all duration-300 ease-in-out peer-checked:max-h-screen peer-checked:px-1 peer-checked:py-2">
                                                    {child.children.map((subChild, subIdx) => (
                                                        <Link
                                                            ...
                                                            to={subChild.link}
                                                            onClick={onDismiss}
                                                            className="text-secondary hover:text-primary hover:border-light-secondary hover:shadow-neumorphic-xs dark:hover:border-dark-secondary ml-4 block rounded-lg border border-transparent bg-inherit p-2 text-sm transition">
                                                            {subChild.name}
                                                        </Link>
                                                    ))}
                                                </div>
                ...
                <div className="border-light-secondary dark:border-dark-secondary border-t border-dotted"></div>
                ...
                <Link
                    onClick={onDismiss}
                    className="font-aladin hover:border-light-secondary hover:shadow-neumorphic-xs dark:hover:border-dark-secondary flex w-full cursor-pointer items-center justify-between rounded-lg border border-transparent bg-inherit p-3 text-left tracking-widest text-red-500 transition hover:text-red-600">
                    <div className="flex items-center gap-3">
